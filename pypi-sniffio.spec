...
Source0  : https://files.pythonhosted.org/packages/a2/87/a6771e1546d97e7e041b6ae58d80074f81b7d5121207425c964ddf5cfdbd/sniffio-1.3.1.tar.gz
...
%prep
%setup -q -n sniffio-1.3.1
cd %{_builddir}/sniffio-1.3.1
pushd ..
cp -a sniffio-1.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708969518
